...
var $author$project$Main$isTouching = F2(
	function (_v0, _v1) {
		var x1 = _v0.a;
		var y1 = _v0.b;
		var x2 = _v1.a;
		var y2 = _v1.b;
		return ($elm$core$Basics$abs(x1 - x2) < 20) && ($elm$core$Basics$abs(y1 - y2) < 20);
	});
var $author$project$Main$cloneIfTouched = F2(
	function (touchPos, _v0) {
		var pos = _v0.a;
		var ast = _v0.b;
		if (A2($author$project$Main$isTouching, pos, touchPos)) {
			var clonedAST = A2(
				$author$project$Main$ASTxy,
				_Utils_Tuple2(pos.a + 10, pos.b + 10),
				ast);
			return clonedAST;
		} else {
			return A2($author$project$Main$ASTxy, pos, ast);
		}
	});
var $author$project$Main$cloneTouchBlock = F2(
	function (pos, model) {
		var newModel = _Utils_update(
			model,
			{
				getASTRoots: A2(
					$elm$core$List$map,
					$author$project$Main$cloneIfTouched(pos),
					model.getASTRoots)
			});
		return newModel;
	});
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$placeholder('ユナイテッド'),
